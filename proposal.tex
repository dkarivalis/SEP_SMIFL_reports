...
The customer should be able to register and login to the system in a simple and straight forward
manner requesting the least amount of information necessary in order to use the system.
...
The customer should be able to push messages to their social media personality.
...
The customer should see a ticker of the most recent trades scroll across the bottom of their
screen at a speed such that they can read and process the information easily.
...
The customer should experience a unified experience across mobile, tablet, and desktop browswers.
The customer should be able to use the three major modern browsers.
...
The customer should be able to place orders to buy, sell, short, stop, and limit on any
tradeable asset available on the NYSE and the NASDAQ.  The customer should be able to
cancel any pending orders that have not gone through.

\section{Graphs and News}

The customer should be presented with a news feed related to his portfolio, and should
be able to manipulate graphs llllllin order to compare performance of a variety of tradeable
assets.
...
The end user should be able to receive email updates at a frequency that they choose.
...
Users should be able to create, modify, and participate in leagues that agree to a customizable
set of rules to determine a winner.

\section{Achievments}

Users should receive recognition of achievments accomplished, eg: earn 10\% in a month.
